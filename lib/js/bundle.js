...
/***/ function(module, exports, __webpack_require__) {
	...
	document.addEventListener("DOMContentLoaded", function() {
	  ...
	  line.graphics.endStroke();
		...
		aboutModal.graphics.beginFill('#faeee7');
		aboutModal.graphics.setStrokeStyle(2,'round').beginStroke('#faeee7');
		aboutModal.alpha = 1;
		...
		var modalLabel = new createjs.Text("Really Little Alchemy", "40px Fantasy", "#594a4e");
		modalLabel.x = 490;
		modalLabel.y = 120;
		...
		buttonok.graphics.beginFill('#ff8ba7');
		buttonok.graphics.setStrokeStyle(2,'round').beginStroke('#33272a');
		...
		var buttonokLabel = new createjs.Text("Continue", "20px Fantasy", "#33272a");
		buttonokLabel.x = 640;
		buttonokLabel.y = 360;
		modalDescription.lineWidth = 300;
		modalDescription.lineHeight = 20;
